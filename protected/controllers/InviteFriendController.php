...
class InviteFriendController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('InviteFriend');
	...
	{
		$model=new InviteFriend('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['InviteFriend']))
			$model->attributes=$_GET['InviteFriend'];
	 ...
	 * @return InviteFriend the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=InviteFriend::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param InviteFriend $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='invite-friend-form')
		{
